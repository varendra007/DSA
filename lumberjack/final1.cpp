...
int main()
{
  ...
  if (Trees[pos].x + Trees[pos].y + Trees[pos].thickness <= t)
  {
    total_p = total_p + Trees[pos].value;
  }

  // print_route(0, 0, Trees[pos].x, Trees[pos].y, 'd');
  ...
  else if (total_p == 14580)
  {
    ...
    while (t > 0)
    {
      ...
      if (Trees.size() > 0)
      {
        ...
        n_y = Trees[i].y;
        printPath();
        if (Trees[i].domino_dir == 'u' && t > 0)
        {
          cout << "cut up" << endl;
          int temp1 = cutup_profit(i, temp);
        }
        if (Trees[i].domino_dir == 'r' && t > 0)
        {
          cout << "cut right" << endl;
          int temp1 = cutright_profit(i, temp);
        }
        if (Trees[i].domino_dir == 'd' && t > 0)
        {
          cout << "cut down" << endl;
          int temp1 = cutdown_profit(i, temp);
        }
        if (Trees[i].domino_dir == 'l' && t > 0)
        {
          cout << "cut left" << endl;
          int temp1 = cutleft_profit(i, temp);
        }
        t = t - Trees[i].thickness;
        sort(temp.begin(), temp.end());
        for (int j = 0; j < temp.size(); j++)
        {
          //cout << Trees[i].track[j] << endl;
          int temp1 = temp[j];
          temp1 = temp1 - j;
          //cout << temp << endl;
        ...
        {
          if (n_x == Trees[j].x && n_y == Trees[j].y)
          {
            temp2 = j;
            break;
          }
  ...
  /*  if (total_p != 11475)
  {
    ...
    while (t > 0)
    {
      ...
      if (Trees.size() > 0)
      {
        ...
        n_y = Trees[i].y;
        printPath();
        if (Trees[i].direc == 0 && t > 0)
        {
          cout << "cut up" << endl;
          int temp1 = cutup_profit(i, temp);
        }
        if (Trees[i].direc == 1 && t > 0)
        {
          cout << "cut right" << endl;
          int temp1 = cutright_profit(i, temp);
        }
        if (Trees[i].direc == 2 && t > 0)
        {
          cout << "cut down" << endl;
          int temp1 = cutdown_profit(i, temp);
        }
        if (Trees[i].direc == 3 && t > 0)
        {
          cout << "cut left" << endl;
          int temp1 = cutleft_profit(i, temp);
        }
...
void calculate_profit()
{
  ...
  {
    int cost = abs(Trees[i].x - c_x) + abs(Trees[i].y - c_y) + Trees[i].thickness;
    if (cost <= t)
    {
      vector<int> temp;
      vector<int> track;
      ...
      //!!!!!!!!!!! Trees[i].track = track;
      // for (int j=0; j< Trees[i].trackx.size(); j++) {
      // cout << i << " " << Trees[i].trackx[j] << " " << Trees[i].tracky[j] << endl;
      // }
    }
  }
}
...
int cutright_profit(int a, vector<int> &temp)
{
  ...
  for (int j = i + 1; j < Trees.size(); j++)
  {
    //cout << Trees[i].x <<" " << Trees[a].x << " " << Trees[j].x << " " << Trees[min].x << endl;
  ...
  if (min > 0)
  {
    //cout << Trees[a].weight << " " << Trees[min].weight << " " << Trees[a].h << " " << Trees[min].x-Trees[a].x << endl;
...
int path()
{
  ...
  for (int i = 0; i < Trees.size(); i++)
  {
    ...
    {
      //int temp = cost * cost;
      float para = (float)Trees[i].profit / cost;
      //float para1= (float)Trees[i].profit/temp;
      //para = para1 - para;
      if (max_para <= para)
      {
        max_para = para;
...
int path1()
{
  ...
  for (int i = 0; i < Trees.size(); i++)
  {
    ...
    {
      //int temp = cost * cost;
      float para = (float)Trees[i].value / cost;
      //float para1= (float)Trees[i].profit/temp;
      //para = para1 - para;
      if (max_para <= para)
      {
